...
function [out1] = model_info() % informations about the model
    ...
    mod.s_ss = [15.9210924096 ; 1.4354499511 ; 0 ; 0];
    mod.x_ss = [0.33 ; 1.0296677196 ; 1.0111223458 ; 0.0125];
    mod.params = [1 ; 1.56214685313 ; 2 ; 0.95 ; 2.56 ; 0.989 ; 0.36 ; 0.019 ; 0.0125 ; 0.5 ; 0 ; 0.95 ; 0.007 ; 0.0089 ; 0.164383140103];
    mod.X = cell(2,1);
    mod.X{1} = [ 0.33        1.02966772  1.01112235  0.0125    ];
    mod.X{2} = [[ -9.05955502e-03   1.87065531e-16   1.50376381e-01  -2.56858560e-04 ;   2.37669902e-02  -2.44073453e-16   3.14428217e-01  -7.45850616e-03 ;  -1.67738372e-03  -1.21340700e-16   3.45147946e-02  -1.93266164e-05 ;  -3.20116509e-02   7.05353746e-01  -2.64029366e-01   8.91910287e-01]];
    out1 = mod;
