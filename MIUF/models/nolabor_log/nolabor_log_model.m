...
function [out1] = model_info() % informations about the model
    ...
    mod.s_ss = [48.2457345745 ; 7.16393700614 ; 0 ; 0];
    mod.x_ss = [3.1202052109 ; 1.0111223458 ; 0.0125];
    mod.params = [0.95 ; 0.989 ; 0.36 ; 0.019 ; 0.0125 ; 0.5 ; 0 ; 0.95 ; 0.007 ; 0.0089];
    mod.X = cell(2,1);
    mod.X{1} = [ 3.12020521  1.01112235  0.0125    ];
    mod.X{2} = [[  4.05990678e-02   0.00000000e+00   8.77304618e-01   8.65962914e-17 ;  -3.87807137e-04   0.00000000e+00   2.73537100e-02   2.70613411e-18 ;  -1.31743117e-02   1.41332901e-01  -2.84683495e-01   9.54633205e-01]];
    out1 = mod;
